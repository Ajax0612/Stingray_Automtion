...
public void NewBusinessFlow(String code,String event) throws ErrorInTestMethod{
	...
	try{
		...
		if(((String)common.NB_excel_data_map.get("CD_MaterialDamage")).equals("Yes")){		
			...
			customAssert.assertTrue(common_CCF.funcInsuredProperties(common.NB_excel_data_map), "Insured Property function is having issue(S) . ");
		}
...
/*public boolean funcPolicyDetails(Map<Object, Object> map_data,String code ,String event){
	...
	try{
		...
		if(((String)map_data.get("PD_TaxExempt")).equalsIgnoreCase("Yes")){
			TestUtil.WriteDataToXl(code+"_"+event, "Premium Summary",(String)common.NB_excel_data_map.get("Automation Key"), "PS_IPTRate", "0", common.NB_excel_data_map);
			TestUtil.WriteDataToXl(code+"_"+event, "Premium Summary",(String)common.NB_excel_data_map.get("Automation Key"), "PS_InsuranceTaxButton", "Yes", common.NB_excel_data_map);
		}else{
			TestUtil.WriteDataToXl(code+"_"+event, "Premium Summary",(String)common.NB_excel_data_map.get("Automation Key"), "PS_IPTRate", "10", common.NB_excel_data_map);
		}
...
public boolean funcMarineCargo(Map<Object, Object> map_data){
	...
	try{
		...
		TestUtil.WriteDataToXl(CommonFunction.product+"_"+CommonFunction.businessEvent, "Premium Summary",(String)common.NB_excel_data_map.get("Automation Key"), "PS_MarineCargo_NP", String.valueOf(sPremiumm), common.NB_excel_data_map);
...
public boolean funcCyberAndDataSecurity(Map<Object, Object> map_data){
	...
	try{
		...
		TestUtil.WriteDataToXl(CommonFunction.product+"_"+CommonFunction.businessEvent, "Premium Summary",(String)common.NB_excel_data_map.get("Automation Key"), "PS_CyberandDataSecurity_NP", String.valueOf(sPremiumm), common.NB_excel_data_map);
...
public boolean funcDirectorsAndOfficers(Map<Object, Object> map_data){
	...
	try{
		...
		TestUtil.WriteDataToXl(CommonFunction.product+"_"+CommonFunction.businessEvent, "Premium Summary",(String)common.NB_excel_data_map.get("Automation Key"), "PS_DirectorsandOfficers_NP", String.valueOf(sPremiumm), common.NB_excel_data_map);
...
public boolean funcFrozenFoods(Map<Object, Object> map_data){
	...
	try{
		...
		TestUtil.WriteDataToXl(CommonFunction.product+"_"+CommonFunction.businessEvent, "Premium Summary",(String)common.NB_excel_data_map.get("Automation Key"), "PS_FrozenFoods_NP", String.valueOf(sPremiumm), common.NB_excel_data_map);
