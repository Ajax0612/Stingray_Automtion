...
public class CommonFunction_CCD extends TestBase{
	...
	public void NewBusinessFlow(String code,String event) throws ErrorInTestMethod{
		...
		try{
			...
			if(((String)common.NB_excel_data_map.get("CD_PersonalAccidentStandard")).equals("Yes")){	
				...
				customAssert.assertTrue(PersonalAccidentStandardPage(common.NB_excel_data_map), "Personal Accident Standard function is having issue(S) . ");
			}
	...
	if(fp_Table.isDisplayed()){
		...
		for(int row = row_index; row < fp_tble_Rows ;row ++){
			...
			default:
				...
				else if(TestBase.product.contains("DOB"))
				{
					sectionName = "D&O";
				}
