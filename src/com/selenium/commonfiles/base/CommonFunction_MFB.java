...
public class CommonFunction_MFB extends TestBase{
	...
	public String CARS_Premium , CV_Premium , AV_Premium , ST_Premium , OT_Premium , TP_Premium , TR_Premium , PAO_Premium = null;
	...
	public void NewBusinessFlow(String code,String event) throws ErrorInTestMethod{
		...
		try{
			...
			if(((String)common.NB_excel_data_map.get("CD_Cars")).equals("Yes")){	
				customAssert.assertTrue(common.funcNextNavigateDecesionMaker(navigationBy,"Cars"),"Issue while Navigating to Cars Cover page ");
				customAssert.assertTrue(Carspage(common.NB_excel_data_map), "Cars function is having issue(S) .");
			}
			
			if(((String)common.NB_excel_data_map.get("CD_CommercialVehicles")).equals("Yes")){
				...
				customAssert.assertTrue(funcCommercialVehicles(common.NB_excel_data_map), "Commercial Vehicles function is having issue(S) .");
			}
			
			//CD_AgriculturalVehicles
			if(((String)common.NB_excel_data_map.get("CD_AgriculturalVehicles")).equals("Yes")){
				...
				customAssert.assertTrue(funcAgriculturalVehicles(common.NB_excel_data_map), "Agricultural Vehicles function is having issue(S) .");
			}
			//SpecialTypepages
			if(((String)common.NB_excel_data_map.get("CD_SpecialTypes")).equals("Yes")){	
				...
				customAssert.assertTrue(SpecialTypepages(common.NB_excel_data_map), "Special Types function is having issue(S) .");
			}
			
			//OtherTypepages
			if(((String)common.NB_excel_data_map.get("CD_OtherTypes")).equals("Yes")){	
				...
				customAssert.assertTrue(OtherTypepages(common.NB_excel_data_map), "Other Types function is having issue(S) .");
			}
			
			
			if(((String)common.NB_excel_data_map.get("CD_TradePlates")).equals("Yes")){	
				...
				customAssert.assertTrue(TradePlatepage(common.NB_excel_data_map), "Trade Plates function is having issue(S) .");
			}
			if(((String)common.NB_excel_data_map.get("CD_Trailers")).equals("Yes")){	
				...
				customAssert.assertTrue(Trailerpage(common.NB_excel_data_map), "Trailers function is having issue(S) .");
			}

			if(((String)common.NB_excel_data_map.get("CD_PersonalAccidentOptional")).equals("Yes")){
				...
				customAssert.assertTrue(PersonalAccidentOptionalPage(common.NB_excel_data_map), "Personal Accident Optional function is having issue(S) .");
			}
			...
			customAssert.assertTrue(funcDrivers(common.NB_excel_data_map), "Drivers function is having issue(S) .");
